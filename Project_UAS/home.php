...
<body>
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="wisata.php"></span><font color="white"> Daftar Wisata</font></a></li>
      <li><a href="booking.php"></span><font color="white"> Booking</font></a></li>
      <li><a href="tentang.php"></span><font color="white"> Tentang</font></a></li>
    </ul>
...
<div class="container">
		...
		<div class="jumbotron bg-dark">
			<h2><font color="white">Selamat Datang di Jogja Explore Tours</font></h2>
		</div>
		</center><hr>
	...
	<div class="container-fluid">
		...
		<div class="row">
      	...
      	<div class="col-sm-4">
      		...
      		<div class="thumbnail">
			  <img src="images/museum_merapi.jpg" class="img-responsive" width="400" height="300">
      	...
      	<center><h5><font color="white">Sindu Kusuma Edupark</font></h5></center>
      	  	<div class="thumbnail">
          	<img src="images/sindu.jpg" class="img-responsive" width="600" height="300">
          	</div>
           	<div class="deskripsi-album"><font color="white">
      	...
      	<center><h5><font color="white">Bunker Kaliadem</font></h5></center>
      	  	<div class="thumbnail">
          	<img src="images/bunker.jpg" class="img-responsive" width="400" height="300">
          	</div>
           	<div class="deskripsi-album"><font color="white">
