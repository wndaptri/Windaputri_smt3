...
<body>
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="admin_wisata.php"><font color="white"> Tempat Wisata</font></a></li>
      <li><a href="admin_user.php"><font color="white">Daftar User</font></a></li>
      <li><a href="admin_booking.php"><font color="white"> Daftar Booking</font></a></li>
    </ul>
